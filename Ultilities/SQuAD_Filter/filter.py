...
parser.add_argument('-train','--train_file', default = "", help='SQuAD-format files that need to be filtered', required=True)
parser.add_argument('-score','--score_file', default = "", help='Score file, produced using squad_filter.py', required=True)
